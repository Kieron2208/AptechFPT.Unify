  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <c:url value="/administrator" var="adminHomeControllerLink"/>
        <a href="adminHomeControllerLink"><b>Unify</b> Shop Admin Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to continue</p>
        <c:url value="/administrator/login" var="loginControllerLink"/>
        <form action="${loginControllerLink}" method="POST">
